...
export default function AddProduct({
  ...
  const addProduct = () => {
    ...
    // Mock API call
    setTimeout(() => {
      console.log("Product Added:", sampleProduct);
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <form action="#">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <button
                            type="button"
                            className="text-gray-900 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
